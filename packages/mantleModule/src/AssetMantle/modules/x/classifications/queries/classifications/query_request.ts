...
export interface QueryRequestProtoMsg {
  typeUrl: "/AssetMantle.modules.x.classifications.queries.classifications.QueryRequest";
  value: Uint8Array;
}
...
export interface QueryRequestAminoMsg {
  type: "/AssetMantle.modules.x.classifications.queries.classifications.QueryRequest";
