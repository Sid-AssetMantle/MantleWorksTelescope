...
export interface TransactionResponseProtoMsg {
  typeUrl: "/AssetMantle.modules.x.identities.transactions.provision.TransactionResponse";
  value: Uint8Array;
}
export interface TransactionResponseAmino {}
export interface TransactionResponseAminoMsg {
  type: "/AssetMantle.modules.x.identities.transactions.provision.TransactionResponse";
