...
export interface QueryResponseProtoMsg {
  typeUrl: "/AssetMantle.modules.x.classifications.queries.classifications.QueryResponse";
  value: Uint8Array;
}
...
export interface QueryResponseAminoMsg {
  type: "/AssetMantle.modules.x.classifications.queries.classifications.QueryResponse";
