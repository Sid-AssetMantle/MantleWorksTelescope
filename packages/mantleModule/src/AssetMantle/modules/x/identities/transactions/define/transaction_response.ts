...
export interface TransactionResponseProtoMsg {
  typeUrl: "/AssetMantle.modules.x.identities.transactions.define.TransactionResponse";
  value: Uint8Array;
}
...
export interface TransactionResponseAminoMsg {
  type: "/AssetMantle.modules.x.identities.transactions.define.TransactionResponse";
