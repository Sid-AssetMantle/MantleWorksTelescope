...
<p align="center">
  <img src="https://user-images.githubusercontent.com/545047/188804067-28e67e5e-0214-4449-ab04-2e0c564a6885.svg" width="80"><br />
    A TS/JS SDK for AssetMantle Chain
</p>

<p align="center" width="100%">
  <a href="https://github.com/Sid-AssetMantle/mantleModule/actions/workflows/run-tests.yml">
    <img height="20" src="https://github.com/Sid-AssetMantle/mantleModule/actions/workflows/run-tests.yml/badge.svg" />
  </a>
   <a href="https://github.com/Sid-AssetMantle/mantleModule/blob/main/LICENSE"><img height="20" src="https://img.shields.io/badge/license-MIT-blue.svg"></a>
</p>
...
```sh
npm install mantleModule
```
## Table of contents

- [mantleModule](#mantleModule)
  - [Install](#install)
...
```js
import { assetmantle } from 'mantleModule';
...
Import the `assetmantle` object from `mantleModule`. 
...
```js
import { cosmwasm } from "mantleModule";
...
```js
import { cosmos } from 'mantleModule';
...
```js
import { getSigningAssetmantleClient } from 'mantleModule';
...
Look inside of `scripts/codegen.ts` and configure the settings for bundling your SDK and contracts into `mantleModule`:
