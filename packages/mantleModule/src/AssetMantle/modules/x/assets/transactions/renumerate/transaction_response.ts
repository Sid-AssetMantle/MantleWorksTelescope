...
export interface TransactionResponseProtoMsg {
  typeUrl: "/AssetMantle.modules.x.assets.transactions.renumerate.TransactionResponse";
  value: Uint8Array;
}
export interface TransactionResponseAmino {}
export interface TransactionResponseAminoMsg {
  type: "/AssetMantle.modules.x.assets.transactions.renumerate.TransactionResponse";
